...
// GUI components
	...
	*/
	...
	public void fillValues() {
			...
			for (int row = 0; row < intArray.length; row++) {
				...
				{
					intArray[row][column] = rand.nextInt(31) + 50;// rand start from 0 - 30
	...
	public void printArray() 
	{
		...
		for (int row = 0; row < intArray.length; row++) {
			for (int column = 0; column < intArray[row].length; column++) 
			{
				...
				animate(row, column); // for creating visual feedback
			}
			System.out.println();
		}
	}
	...
	*/
	...
	public int countFound(int value) 
	{
		...
		for (int row = 0; row < intArray.length; row++) //row  < 4
		{
			for (int column = 0; column < intArray[row].length; column++) 
			{
